...
public class TreasureController {
  @Autowired private TreasureServiceImpl treasureService;
  @Autowired private AwardRecordServiceImpl awardRecordService;
  @Autowired private AwardServiceImpl awardService;
  ...
  @ResponseBody
  public Result buryTreasure(
      HttpServletRequest request, String aid, int num, int credit, String pid, String message) {
    try {
      // 获取请求头中的token令牌
      ...
      if (!treasureService.insertTreasure(treasure)
          || !awardRecordService.addUserBuryAwardRecord(aid, uid, num, credit)) {
