...
远程服务器mysql数据库管理后台[网址](http://123.56.150.89:888/phpmyadmin_0dcf81ed7004a964/db_structure.php?server=1&db=server_db)（用户名：server_db 密码：FULINTAO0709）

```bash
#后端本地服务器ip和端口号
server.host=192.168.1.26
server.port=8888
#远程服务器mysql数据库
